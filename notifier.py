...
class LteModem:
    ...
    Supports three modes:
      ...
      - sim7600: SIM7600G-H HAT in RNDIS mode (usb0, same as tethering)
    ...
    def __init__(self, cfg: dict):
        self._cfg = cfg
        self._mode = cfg.get("mode", "e3372h")  # e3372h, sim7600, or tethering
        self._interface: Optional[str] = None
        self._available = False

    def detect(self) -> bool:
        """Detect if a LTE connection is available."""
        if self._mode in ("tethering", "sim7600"):
            # SIM7600 in RNDIS mode creates usb0, same as tethering
